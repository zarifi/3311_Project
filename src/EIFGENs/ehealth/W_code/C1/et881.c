...
extern EIF_TYPED_VALUE F881_8268(EIF_REFERENCE);
extern void F881_16297(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F881_8268)
EIF_TYPED_VALUE F881_8268 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 13989);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(880, Current, 13989);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F881_16297 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 880, Current, 0, 16296);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
