...
static const EIF_TYPE_INDEX egt_1_882 [] = {0xFF01,1497,881,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_882 [] = {0xFF01,879,0xFFFF};
...
static const struct desc_info desc_882[] = {
	...
	{EIF_GENERIC(egt_14_882), 13991, 0xFFFFFFFF},
};
void Init882(void)
{
	IDSC(desc_882, 0, 881);
	IDSC(desc_882 + 1, 1, 881);
	IDSC(desc_882 + 32, 360, 881);
}
