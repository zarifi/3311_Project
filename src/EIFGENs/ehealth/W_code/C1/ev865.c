...
extern EIF_TYPED_VALUE F865_7027(EIF_REFERENCE);
extern EIF_TYPED_VALUE F865_7028(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F865_7027 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F865_7028 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 864, Current, 0, 1, 12708);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
