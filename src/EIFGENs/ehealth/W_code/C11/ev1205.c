...
extern EIF_TYPED_VALUE F1205_11471(EIF_REFERENCE);
extern void F1205_11472(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1205_11471 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1205_11472 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1204, Current, 0, 0, 17552);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1204, Current, 17552);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8375, 0xF8000541, 0); /* implementation */
