...
extern EIF_TYPED_VALUE F1224_11723(EIF_REFERENCE);
extern void F1224_11724(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1224_11723 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1224_11724 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1223, Current, 0, 0, 17805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1223, Current, 17805);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8375, 0xF800055C, 0); /* implementation */
