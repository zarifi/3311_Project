...
extern EIF_TYPED_VALUE F1237_11877(EIF_REFERENCE);
extern void F1237_11878(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1237_11877 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1237_11878 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1236, Current, 0, 0, 17959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1236, Current, 17959);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8375, 0xF800057A, 0); /* implementation */
