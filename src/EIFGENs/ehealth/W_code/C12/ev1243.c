...
extern EIF_TYPED_VALUE F1243_11906(EIF_REFERENCE);
extern void F1243_11907(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1243_11906 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1243_11907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1242, Current, 0, 0, 17988);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1242, Current, 17988);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8375, 0xF8000584, 0); /* implementation */
