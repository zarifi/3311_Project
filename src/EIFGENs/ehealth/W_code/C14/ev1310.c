...
extern void F1310_13077(EIF_REFERENCE);
static EIF_TYPED_VALUE F1310_13079_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1310_13079(EIF_REFERENCE);
...
void F1310_13077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1309, Current, 0, 0, 18954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1309, Current, 18954);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = '\01';
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10069, dtype))(Current)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10068, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1310_13079_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1309, Current, 0, 0, 18955);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1309, Current, 18955);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1310_13079 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1310_13079_body (Current)).it_r;
