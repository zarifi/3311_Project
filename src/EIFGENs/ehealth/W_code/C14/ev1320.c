...
extern EIF_TYPED_VALUE F1320_13135(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1320_13135 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1319, Current, 0, 0, 18995);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1319, Current, 18995);
	RTIV(Current, RTAL);
	RTHOOK(1);
