...
extern void F1341_13440(EIF_REFERENCE);
extern void F1341_13441(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1341_13442(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1341_13443(EIF_REFERENCE);
static EIF_TYPED_VALUE F1341_13444_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1341_13444(EIF_REFERENCE);
...
void F1341_13440 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 19231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1340, Current, 19231);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9301, 1336))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9301, 1496))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1341_13441 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1340, Current, 1, 2, 19232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1340, Current, 19232);
	RTCC(arg1, 1340, l_feature_name, 1, RTWCT(10267, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		RTHOOK(5);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10325, dtype))(Current)).it_p);
		up1 = tp1;
...
void F1341_13442 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1340, Current, 2, 1, 19233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1340, Current, 19233);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(9898, dtype)) = (EIF_INTEGER_32) loc2;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1341_13443 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 19234);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1340, Current, 19234);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10290, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1341_13444_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 19235);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1340, Current, 19235);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1341_13444 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1341_13444_body (Current)).it_r;
