...
extern EIF_TYPED_VALUE F1345_13496(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1345_13497(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1345_13498(EIF_REFERENCE);
static EIF_TYPED_VALUE F1345_13499_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1345_13499(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1345_13496 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1344, Current, 19276);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7931, "y", tr1))(tr1)).it_i4);
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9952, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F1345_13497 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19277);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1344, Current, 19277);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	...
	RTNHOOK(1,2);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8642, "height", tr2))(tr2)).it_i4);
...
EIF_TYPED_VALUE F1345_13498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19278);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1344, Current, 19278);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9954, Dtype(Current)))(Current)).it_i4);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1345_13499_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19279);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1344, Current, 19279);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1345_13499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1345_13499_body (Current)).it_r;
