...
extern void F1390_14177(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1390_14178(EIF_REFERENCE);
static EIF_TYPED_VALUE F1390_14179_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1390_14179(EIF_REFERENCE);
...
void F1390_14177 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1389, Current, 0, 1, 19782);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1389, Current, 19782);
	RTCC(arg1, 1389, l_feature_name, 1, RTWCT(9306, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1390_14178 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1389, Current, 1, 0, 19783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1389, Current, 19783);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5324, 869))(Current)).it_p);
	RTHOOK(3);
	up1 = loc1;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9301, 1388))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1390_14179_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1389, Current, 0, 0, 19784);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1389, Current, 19784);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1390_14179 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1390_14179_body (Current)).it_r;
