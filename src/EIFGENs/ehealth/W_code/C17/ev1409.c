...
extern EIF_TYPED_VALUE F1409_14587(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1409_14588(EIF_REFERENCE);
extern void F1409_14589(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1409_14590(EIF_REFERENCE);
static EIF_TYPED_VALUE F1409_14591_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1409_14591(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1409_14587 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 20182);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1408, Current, 20182);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1409_14588 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1409_14589 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1408, Current, 0, 1, 20184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1408, Current, 20184);
	RTCC(arg1, 1408, l_feature_name, 1, RTWCT(9306, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1409_14590 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 20185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1408, Current, 20185);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5722, 870))(Current)).it_p);
	up1 = tp1;
...
static EIF_TYPED_VALUE F1409_14591_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 20186);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1408, Current, 20186);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1409_14591 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1409_14591_body (Current)).it_r;
