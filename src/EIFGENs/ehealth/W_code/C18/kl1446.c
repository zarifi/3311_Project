...
extern EIF_TYPED_VALUE F1446_15185(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1446_15185 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1445, Current, 0, 0, 20694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1445, Current, 20694);
	RTIV(Current, RTAL);
	RTHOOK(1);
