...
extern void F1463_15461(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1463_15462(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1463_15463(EIF_REFERENCE);
extern void F1463_15464(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1463_15465(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1463_15466(EIF_REFERENCE);
...
/* {KL_STDERR_FILE}.make */
void F1463_15461 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20913);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20913);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("stderr",6,1911360114);
	ur1 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4677, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1463_15462 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1463_15462,20915,RTMS_EX_H("\012",1,10));
}

/* {KL_STDERR_FILE}.is_open_write */
EIF_TYPED_VALUE F1463_15463 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20915);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1462, Current, 20915);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1463_15464 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1462, Current, 0, 1, 20916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20916);
	RTIV(Current, RTAL);
...
void F1463_15465 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1462, Current, 1, 1, 20917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20917);
	RTCC(arg1, 1462, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_write", EX_PRE);
...
void F1463_15466 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20918);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20918);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_write", EX_PRE);
