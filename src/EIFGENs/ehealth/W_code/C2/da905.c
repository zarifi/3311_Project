...
extern EIF_TYPED_VALUE F905_8427(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8428(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8429(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8430(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8431(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8432(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8433(EIF_REFERENCE);
extern EIF_TYPED_VALUE F905_8434(EIF_REFERENCE);
...
EIF_TYPED_VALUE F905_8427 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F905_8427,14126,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F905_8428)
EIF_TYPED_VALUE F905_8428 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 904, Current, 0, 0, 14126);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(904, Current, 14126);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F905_8429)
EIF_TYPED_VALUE F905_8429 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 904, Current, 0, 0, 14127);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(904, Current, 14127);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
RTOID (F905_8430)
EIF_TYPED_VALUE F905_8430 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 904, Current, 0, 0, 14128);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(904, Current, 14128);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
RTOID (F905_8431)
EIF_TYPED_VALUE F905_8431 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 904, Current, 0, 0, 14129);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(904, Current, 14129);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
EIF_TYPED_VALUE F905_8432 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F905_8432,14123,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F905_8433 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F905_8433,14124,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F905_8434 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F905_8434,14125,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit905 (void)
{
	GTCX
	RTOTS (8427,F905_8427)
	RTOTS (8428,F905_8428)
	RTOTS (8429,F905_8429)
	RTOTS (8430,F905_8430)
	RTOTS (8431,F905_8431)
	RTOTS (8432,F905_8432)
	RTOTS (8433,F905_8433)
	RTOTS (8434,F905_8434)
}
