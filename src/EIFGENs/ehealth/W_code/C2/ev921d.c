...
static const EIF_TYPE_INDEX egt_13_921 [] = {0xFF01,908,0xFFFF};
static const EIF_TYPE_INDEX egt_14_921 [] = {0xFF01,1100,0xFFFF};
static const EIF_TYPE_INDEX egt_15_921 [] = {0xFF01,1100,0xFFFF};
...
static const struct desc_info desc_921[] = {
	...
	{EIF_GENERIC(egt_13_921), 14259, 0},
	{EIF_GENERIC(egt_14_921), 14260, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_921), 14261, 0xFFFFFFFF},
};
void Init921(void)
{
	IDSC(desc_921, 0, 920);
	IDSC(desc_921 + 1, 1, 920);
	IDSC(desc_921 + 32, 632, 920);
}
