...
extern EIF_TYPED_VALUE F902_8417(EIF_REFERENCE);
...
RTOID (F902_8417)
EIF_TYPED_VALUE F902_8417 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 14120);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 14120);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
