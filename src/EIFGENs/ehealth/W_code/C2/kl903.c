...
extern EIF_TYPED_VALUE F903_8418(EIF_REFERENCE);
...
RTOID (F903_8418)
EIF_TYPED_VALUE F903_8418 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 902, Current, 0, 0, 14121);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(902, Current, 14121);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
