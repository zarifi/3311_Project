...
extern EIF_TYPED_VALUE F898_8335(EIF_REFERENCE);
...
RTOID (F898_8335)
EIF_TYPED_VALUE F898_8335 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 14056);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 14056);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
