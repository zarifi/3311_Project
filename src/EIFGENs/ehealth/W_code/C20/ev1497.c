...
extern void F1497_12886(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1497_12887(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1497_12888(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1497_12891(EIF_REFERENCE);
static EIF_TYPED_VALUE F1497_12892_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1497_12892(EIF_REFERENCE);
...
void F1497_12886 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1496, Current, 0, 0, 18816);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1496, Current, 18816);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9932, 0xF800010C, 0); /* child_array */
	tr1 = RTLNSMART(RTWCT(9932, dtype, Dftype(Current)).id);
...
EIF_TYPED_VALUE F1497_12887 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1496, Current, 0, 1, 18817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1496, Current, 18817);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1497_12888 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1496, Current, 0, 0, 18818);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1496, Current, 18818);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9932, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F1497_12891 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
static EIF_TYPED_VALUE F1497_12892_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1496, Current, 0, 0, 18820);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1496, Current, 18820);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1497_12892 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9306, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1497_12892_body (Current)).it_r;
