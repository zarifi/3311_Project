...
extern EIF_TYPED_VALUE F1505_8990(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1505_8991(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1505_8993(EIF_REFERENCE);
extern void F1505_8998(EIF_REFERENCE);
extern void F1505_8999(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1505_8990 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1504, Current, 2, 3, 14602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1504, Current, 14602);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1503,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			ur1 = RTCCL(tr1);
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6518, "put", arg1))(arg1, ur1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F1505_8991 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1504, Current, 0, 0, 14603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1504, Current, 14603);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1505_8993 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1504, Current, 0, 0, 14604);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1504, Current, 14604);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F1505_8998 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1504, Current, 0, 0, 14605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1504, Current, 14605);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1505_8999 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1504, Current, 0, 0, 14606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1504, Current, 14606);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
