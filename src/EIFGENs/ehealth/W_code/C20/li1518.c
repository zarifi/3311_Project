...
extern EIF_TYPED_VALUE F1518_3326(EIF_REFERENCE);
extern void F1518_3327(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1518_3328(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1518_3329(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1518_3330(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1518_3331(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1518_3332(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1518_3326 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1517, Current, 1, 0, 15752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15752);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.force */
void F1518_3327 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1517, Current, 0, 1, 15753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15753);
	RTCC(arg1, 1517, l_feature_name, 1, RTWCT(1747, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2495, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {LINKED_STACK}.extend */
void F1518_3328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1517, Current, 0, 1, 15754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15754);
	RTCC(arg1, 1517, l_feature_name, 1, RTWCT(1747, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1518_3329 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1517, Current, 0, 1, 15755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15755);
	RTCC(arg1, 1517, l_feature_name, 1, RTWCT(1747, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.remove */
void F1518_3330 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1517, Current, 0, 0, 15756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15756);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2564, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
EIF_TYPED_VALUE F1518_3331 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1517, Current, 1, 0, 15757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15757);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(5);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2563, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
...
EIF_TYPED_VALUE F1518_3332 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1517, Current, 3, 1, 15758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1517, Current, 15758);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if (tb2) {
			tb2 = *(EIF_BOOLEAN *)(Current + RTWA(2560, dtype));
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			...
			RTHOOK(10);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(1795, "finish", loc3))(loc3);
			RTHOOK(11);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2563, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2497, "put_right", loc3))(loc3, ur1x);
			RTHOOK(12);
