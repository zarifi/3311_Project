...
extern EIF_TYPED_VALUE F949_8765(EIF_REFERENCE);
static EIF_TYPED_VALUE F949_8767_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F949_8767(EIF_REFERENCE);
extern EIF_TYPED_VALUE F949_8768(EIF_REFERENCE);
static EIF_TYPED_VALUE F949_8770_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F949_8770(EIF_REFERENCE);
...
EIF_TYPED_VALUE F949_8765 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14437);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(948, Current, 14437);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6679, 0xF800044C, 0); /* select_actions_internal */
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6679, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(3);
...
static EIF_TYPED_VALUE F949_8767_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14438);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(948, Current, 14438);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F949_8767 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6679, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F949_8767_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(948, Current, 14439);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6682, 0xF800044C, 0); /* deselect_actions_internal */
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6682, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
...
static EIF_TYPED_VALUE F949_8770_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14440);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(948, Current, 14440);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F949_8770 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6682, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F949_8770_body (Current)).it_r;
