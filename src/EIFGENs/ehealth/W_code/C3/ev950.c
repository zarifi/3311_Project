/*
 * Code for class EV_LIST_ITEM_ACTION_SEQUENCES_IMP
 */
...
/* {EV_LIST_ITEM_ACTION_SEQUENCES_IMP}.create_select_actions */
EIF_TYPED_VALUE F950_8771 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14441);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(949, Current, 14441);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_LIST_ITEM_ACTION_SEQUENCES_IMP}.create_deselect_actions */
EIF_TYPED_VALUE F950_8772 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(949, Current, 14442);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1100, 0x01).id);
