...
extern EIF_TYPED_VALUE F952_8779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_8780(EIF_REFERENCE);
...
EIF_TYPED_VALUE F952_8779 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14447);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(951, Current, 14447);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F952_8780 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14448);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(951, Current, 14448);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1100, 0x01).id);
