...
extern EIF_TYPED_VALUE F954_8787(EIF_REFERENCE);
extern EIF_TYPED_VALUE F954_8788(EIF_REFERENCE);
...
EIF_TYPED_VALUE F954_8787 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 953, Current, 0, 0, 14453);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(953, Current, 14453);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F954_8788 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 953, Current, 0, 0, 14454);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(953, Current, 14454);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1100, 0x01).id);
