...
extern EIF_TYPED_VALUE F962_8832(EIF_REFERENCE);
...
EIF_TYPED_VALUE F962_8832 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 14487);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 14487);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800043F, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1087, 0x01).id);
