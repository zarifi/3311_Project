/*
 * Code for class EV_DRAWING_AREA_ACTION_SEQUENCES_IMP
 */
...
extern EIF_TYPED_VALUE F964_8836(EIF_REFERENCE);
...
/* {EV_DRAWING_AREA_ACTION_SEQUENCES_IMP}.create_expose_actions */
EIF_TYPED_VALUE F964_8836 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 963, Current, 1, 0, 14490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(8835,1);
	RTDBGEAA(963, Current, 14490);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6733, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(3);
	...
	RTCOMS(tr3,8835,0,"expose-event",12,1736732276);
	ur1 = tr3;
	...
	RTAR(tr3,tr4);
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6731, dtype))(Current)).it_p);
