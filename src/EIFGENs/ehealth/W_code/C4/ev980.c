...
extern EIF_TYPED_VALUE F980_8892(EIF_REFERENCE);
static EIF_TYPED_VALUE F980_8894_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_8894(EIF_REFERENCE);
...
EIF_TYPED_VALUE F980_8892 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14519);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 14519);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6780, 0xF800044C, 0); /* select_actions_internal */
	...
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6780, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
static EIF_TYPED_VALUE F980_8894_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14520);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(979, Current, 14520);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F980_8894 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6780,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6780, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F980_8894_body (Current)).it_r;
