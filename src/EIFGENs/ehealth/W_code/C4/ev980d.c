...
static const EIF_TYPE_INDEX egt_13_980 [] = {0xFF01,1100,0xFFFF};
static const EIF_TYPE_INDEX egt_14_980 [] = {0xFF01,1100,0xFFFF};
...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_13_980), 14519, 0xFFFFFFFF},
