/*
 * Code for class EV_MENU_ITEM_ACTION_SEQUENCES_IMP
 */
...
/* {EV_MENU_ITEM_ACTION_SEQUENCES_IMP}.create_select_actions */
EIF_TYPED_VALUE F981_8895 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 14521);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(980, Current, 14521);
	RTIV(Current, RTAL);
	RTHOOK(1);
