/*
 * Class EV_MENU_ITEM_ACTION_SEQUENCES_IMP
 */
...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,1100,0xFFFF};
static const EIF_TYPE_INDEX egt_14_981 [] = {0xFF01,1100,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_GENERIC(egt_13_981), 14519, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_981), 14521, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0899 /*1100*/), 14520, 0},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 771, 980);
}
