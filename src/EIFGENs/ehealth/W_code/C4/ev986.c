...
extern EIF_TYPED_VALUE F986_8916(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8917(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8918(EIF_REFERENCE);
...
EIF_TYPED_VALUE F986_8916 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14538);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14538);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F986_8917 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14539);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14539);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1100, 0x01).id);
...
EIF_TYPED_VALUE F986_8918 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14540);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14540);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1100, 0x01).id);
