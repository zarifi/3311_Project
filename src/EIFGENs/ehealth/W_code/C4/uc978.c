...
extern EIF_TYPED_VALUE F978_8890(EIF_REFERENCE);
...
RTOID (F978_8890)
EIF_TYPED_VALUE F978_8890 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 14517);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 14517);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
