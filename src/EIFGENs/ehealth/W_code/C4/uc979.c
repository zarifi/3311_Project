...
extern EIF_TYPED_VALUE F979_8891(EIF_REFERENCE);
...
RTOID (F979_8891)
EIF_TYPED_VALUE F979_8891 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 14518);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 14518);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
