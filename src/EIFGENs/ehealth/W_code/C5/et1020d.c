...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,1020,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1020 [] = {0xFF01,220,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1020 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_GENERIC(egt_9_1020), 14872, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1020), 14869, 0},
	{EIF_GENERIC(egt_14_1020), 14870, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1020), 14871, 0xFFFFFFFF},
};
void Init1020(void)
{
	IDSC(desc_1020, 0, 1019);
	IDSC(desc_1020 + 1, 1, 1019);
	IDSC(desc_1020 + 32, 406, 1019);
	IDSC(desc_1020 + 34, 401, 1019);
}
