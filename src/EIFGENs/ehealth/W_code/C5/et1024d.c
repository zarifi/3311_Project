...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,220,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1024 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_9_1024), 14884, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1024), 14882, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1024), 14883, 0xFFFFFFFF},
};
void Init1024(void)
{
	IDSC(desc_1024, 0, 1023);
	IDSC(desc_1024 + 1, 1, 1023);
	IDSC(desc_1024 + 32, 401, 1023);
}
