...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14707);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6980, 0xF800044C, 0); /* close_request_actions_internal */
...
static EIF_TYPED_VALUE F1003_9121_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14708);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 14708);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1003_9121 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6980, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_9121_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14709);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6983, 0xF8000449, 0); /* move_actions_internal */
...
static EIF_TYPED_VALUE F1003_9124_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14710);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 14710);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1003_9124 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6983, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_9124_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14711);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6986, 0xF800044C, 0); /* show_actions_internal */
...
static EIF_TYPED_VALUE F1003_9127_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14712);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 14712);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1003_9127 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6986, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_9127_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14713);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6989, 0xF800044C, 0); /* hide_actions_internal */
...
static EIF_TYPED_VALUE F1003_9130_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14714);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 14714);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1003_9130 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6989, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_9130_body (Current)).it_r;
