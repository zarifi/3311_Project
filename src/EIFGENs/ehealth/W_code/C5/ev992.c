/*
 * Code for class EV_PIXMAP_ACTION_SEQUENCES_IMP
 */
...
extern EIF_REFERENCE _A1157_324_3_4_5_6();
...
/* {EV_PIXMAP_ACTION_SEQUENCES_IMP}.create_expose_actions */
EIF_TYPED_VALUE F992_8980 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "create_expose_actions";
	RTEX;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 991, Current, 1, 0, 14598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(8979,1);
	RTDBGEAA(991, Current, 14598);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6861, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(3);
	...
	RTCOMS(tr3,8979,0,"expose-event",12,1736732276);
	ur1 = tr3;
	...
	RTAR(tr3,tr4);
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6859, dtype))(Current)).it_p);
	...
	*((EIF_INTEGER_32 *)tr5+3) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr6 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1157_324_3_4_5_6, (EIF_POINTER)(0),8263, tr4, 0, 1, -1, tr3, 4);
	}
	ur2 = RTCCL(tr6);
	...
	RTNHOOK(3,3);
	tr8 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8343, "expose_translate_agent", tr7))(tr7)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur3 = RTCCL(tr8);
	ub1 = (EIF_BOOLEAN) 0;
