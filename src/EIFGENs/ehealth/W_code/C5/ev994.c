...
extern EIF_TYPED_VALUE F994_8987(EIF_REFERENCE);
...
EIF_TYPED_VALUE F994_8987 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 14601);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(993, Current, 14601);
	RTIV(Current, RTAL);
	RTHOOK(1);
