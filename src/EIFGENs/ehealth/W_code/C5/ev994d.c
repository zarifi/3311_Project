/*
 * Class EV_TEXT_FIELD_ACTION_SEQUENCES_IMP
 */
...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,1100,0xFFFF};
static const EIF_TYPE_INDEX egt_14_994 [] = {0xFF01,1100,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 14599, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_994), 14601, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0899 /*1100*/), 14600, 0},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
	IDSC(desc_994 + 1, 1, 993);
	IDSC(desc_994 + 32, 681, 993);
}
