...
extern EIF_TYPED_VALUE F1017_9319(EIF_REFERENCE);
...
RTOID (F1017_9319)
EIF_TYPED_VALUE F1017_9319 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1016, Current, 0, 0, 14867);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 14867);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
