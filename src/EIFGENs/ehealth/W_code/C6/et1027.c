...
extern void F1027_9348(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1027_9349(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1027_9350(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1027_9351(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1027_9352(EIF_REFERENCE);
...
/* {ETF_ENUM_PARAM}.make */
void F1027_9348 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1026, Current, 0, 1, 14894);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1026, Current, 14894);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 7158, 0xF8000123, 0); /* items */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7158, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1027_9349 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1027_9350 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1026, Current, 0, 0, 14896);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1026, Current, 14896);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1027_9351 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1026, Current, 1, 0, 14897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1026, Current, 14897);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
	...
	for (;;) {
		...
		RTHOOK(5);
		tr1 = RTMS_EX_H("\"",1,34);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7158, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ui4_1 = loc1;
...
/* {ETF_ENUM_PARAM}.out */
EIF_TYPED_VALUE F1027_9352 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1026, Current, 1, 0, 14898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1026, Current, 14898);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(220, 0x01).id);
