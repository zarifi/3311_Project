...
extern EIF_TYPED_VALUE F1030_9361(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1030_9362(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1030_9361 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1029, Current, 0, 0, 14909);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1029, Current, 14909);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1030_9362 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1029, Current, 0, 0, 14907);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1029, Current, 14907);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
...
EIF_TYPED_VALUE F1030_9363 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1029, Current, 0, 0, 14908);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1029, Current, 14908);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
