...
extern void F1048_9432(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1048_9433(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1048_9434(EIF_REFERENCE);
extern void F1048_9435(EIF_REFERENCE);
extern void F1048_9436(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1048_9432 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1047, Current, 1, 0, 14977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 14977);
	RTIV(Current, RTAL);
	wstdinit(loc1,loc1);
	RTLXI(loc1);
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7217, 0xF800036F, 0); /* model */
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7217, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1048_9433 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1048_9434 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 14979);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1047, Current, 14979);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7217, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
...
void F1048_9435 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 14980);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 14980);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1048_9436 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1047, Current, 1, 1, 14981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 14981);
	RTCC(arg1, 1047, l_feature_name, 1, eif_new_type(1114, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
