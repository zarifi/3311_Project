...
extern EIF_TYPED_VALUE F1064_9823(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1064_9823 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1063, Current, 0, 0, 15360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1063, Current, 15360);
	RTIV(Current, RTAL);
