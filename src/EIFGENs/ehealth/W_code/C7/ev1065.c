...
extern EIF_TYPED_VALUE F1065_9824(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1065_9824 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1064, Current, 0, 0, 15361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1064, Current, 15361);
	RTIV(Current, RTAL);
