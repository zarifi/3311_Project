...
extern EIF_TYPED_VALUE F1081_10097(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1081_10097 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1080, Current, 0, 1, 15794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1080, Current, 15794);
	RTCC(arg1, 1080, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
