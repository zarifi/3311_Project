...
extern EIF_TYPED_VALUE F1073_9977(EIF_REFERENCE);
...
RTOID (F1073_9977)
EIF_TYPED_VALUE F1073_9977 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1072, Current, 0, 0, 15655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1072, Current, 15655);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
