/*
 * Code for class ETF_PRESCRIPTIONS_Q_INTERFACE
 */
...
extern void F1117_10354(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1117_10355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1117(void);
extern EIF_REFERENCE _A1117_58_2();
...
/* {ETF_PRESCRIPTIONS_Q_INTERFACE}.make */
void F1117_10354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1116, Current, 1, 3, 16304);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1116, Current, 16304);
	RTCC(arg1, 1116, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1116, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1116, l_feature_name, 3, eif_new_type(939, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,252,0xFF01,0xFFF9,1,174,188,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1117_58_2, (EIF_POINTER)(0),7990, tr2, 0, 1, -1, tr1, 1);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(7978, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	tr1 = RTCCL(tr2);
	RTOB(*(EIF_INTEGER_64 *), eif_new_type(188, 0x00), tr1, loc1, tb1);
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 7986, 0xF80000DC, 0); /* out */
		tr1 = RTMS_EX_H("prescriptions_q(",16,1714751528);
		tr2 = RTMS_EX_H("prescriptions_q",15,2095457905);
		ur1 = tr2;
		tr3 = RTMS_EX_H("medication_id",13,1998285668);
		ur2 = tr3;
...
/* {ETF_PRESCRIPTIONS_Q_INTERFACE}.prescriptions_q_precond */
EIF_TYPED_VALUE F1117_10355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "prescriptions_q_precond";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1116, Current, 0, 1, 16305);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1116, Current, 16305);
	RTIV(Current, RTAL);
	RTHOOK(1);
