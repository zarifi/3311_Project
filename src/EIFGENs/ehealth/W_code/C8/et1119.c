/*
 * Code for class ETF_REMOVE_MEDICINE_INTERFACE
 */
...
extern void F1119_10358(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1119_10359(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1119(void);
extern EIF_REFERENCE _A1119_58_2_3();
...
/* {ETF_REMOVE_MEDICINE_INTERFACE}.make */
void F1119_10358 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1118, Current, 2, 3, 16307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1118, Current, 16307);
	RTCC(arg1, 1118, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
	...
	RTCC(arg3, 1118, l_feature_name, 3, eif_new_type(939, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+1) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1119_58_2_3, (EIF_POINTER)(0),7992, tr2, 0, 1, -1, tr1, 2);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(7978, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	if (tb1) {
		...
		tr1 = RTMS_EX_H("remove_medicine(",16,1510568488);
...
/* {ETF_REMOVE_MEDICINE_INTERFACE}.remove_medicine_precond */
EIF_TYPED_VALUE F1119_10359 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
	char *l_feature_name = "remove_medicine_precond";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1118, Current, 0, 2, 16308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1118, Current, 16308);
	RTIV(Current, RTAL);
	RTHOOK(1);
