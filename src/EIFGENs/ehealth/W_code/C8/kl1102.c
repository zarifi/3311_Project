...
extern EIF_TYPED_VALUE F1102_10217(EIF_REFERENCE);
...
RTOID (F1102_10217)
EIF_TYPED_VALUE F1102_10217 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1101, Current, 0, 0, 16172);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1101, Current, 16172);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
