...
extern EIF_TYPED_VALUE F1103_10218(EIF_REFERENCE);
...
RTOID (F1103_10218)
EIF_TYPED_VALUE F1103_10218 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1102, Current, 0, 0, 16173);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1102, Current, 16173);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
