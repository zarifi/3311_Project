/*
 * Code for class ETF_ADD_PHYSICIAN_INTERFACE
 */
...
extern void F1129_10378(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1129_10379(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1129(void);
extern EIF_REFERENCE _A1129_58_2_3_4();
...
/* {ETF_ADD_PHYSICIAN_INTERFACE}.make */
void F1129_10378 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1128, Current, 3, 3, 16322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1128, Current, 16322);
	RTCC(arg1, 1128, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
	...
	RTCC(arg3, 1128, l_feature_name, 3, eif_new_type(939, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+2) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,252,0xFF01,0xFFF9,3,174,188,0xFF01,220,188,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1129_58_2_3_4, (EIF_POINTER)(0),8002, tr2, 0, 1, -1, tr1, 3);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(7978, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	if (tb3) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(eif_new_type(220, 0x01),loc2);
		tb2 = EIF_TEST(loc2);
	}
	if (tb2) {
		ui4_1 = ((EIF_INTEGER_32) 3L);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2392, "item", arg2))(arg2, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tr1 = RTCCL(tr2);
		RTOB(*(EIF_INTEGER_64 *), eif_new_type(188, 0x00), tr1, loc3, tb2);
		tb1 = tb2;
	}
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 7986, 0xF80000DC, 0); /* out */
		tr1 = RTMS_EX_H("add_physician(",14,217272360);
		...
		*(EIF_INTEGER_64 *)ur3 = loc1;
		...
		tr2 = RTMS_EX_H("add_physician",13,2131551342);
		ur1 = tr2;
		tr3 = RTMS_EX_H("kind",4,1802071652);
		ur2 = tr3;
		ur3 = RTLN(eif_new_type(188, 0x00).id);
...
/* {ETF_ADD_PHYSICIAN_INTERFACE}.add_physician_precond */
EIF_TYPED_VALUE F1129_10379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
	char *l_feature_name = "add_physician_precond";
	RTEX;
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 1128, Current, 0, 3, 16323);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1128, Current, 16323);
	RTCC(arg2, 1128, l_feature_name, 2, eif_new_type(220, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = '\0';
	tr1 = RTMS_EX_H("ID_MD = INTEGER_64",18,1724473652);
	ur1 = tr1;
	tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7172, dtype))(Current, ur1x)).it_b);
	if (tb3) {
		tr1 = RTMS_EX_H("NAME = STRING",13,477681991);
		ur1 = tr1;
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7172, dtype))(Current, ur1x)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		ui8_1 = arg3;
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7163, dtype))(Current, ui8_1x)).it_b);
		tb1 = tb2;
	}
