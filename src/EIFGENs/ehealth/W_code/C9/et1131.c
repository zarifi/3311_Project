/*
 * Code for class ETF_NEW_PRESCRIPTION_INTERFACE
 */
...
extern void F1131_10382(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1131_10383(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1131(void);
extern EIF_REFERENCE _A1131_58_2_3_4();
...
/* {ETF_NEW_PRESCRIPTION_INTERFACE}.make */
void F1131_10382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 3, 3, 16325);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16325);
	RTCC(arg1, 1130, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1130, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1130, l_feature_name, 3, eif_new_type(939, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+2) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,252,0xFF01,0xFFF9,3,174,188,188,188,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1131_58_2_3_4, (EIF_POINTER)(0),8004, tr2, 0, 1, -1, tr1, 3);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(7978, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	if (tb1) {
		...
		tr1 = RTMS_EX_H("new_prescription(",17,742813480);
		...
		*(EIF_INTEGER_64 *)ur3 = loc1;
		...
		tr2 = RTMS_EX_H("new_prescription",16,2007775342);
		ur1 = tr2;
		tr3 = RTMS_EX_H("doctor",6,1866035570);
		ur2 = tr3;
		ur3 = RTLN(eif_new_type(188, 0x00).id);
		*(EIF_INTEGER_64 *)ur3 = loc2;
		...
		tr2 = RTMS_EX_H("new_prescription",16,2007775342);
		ur1 = tr2;
		tr3 = RTMS_EX_H("patient",7,349346676);
		ur2 = tr3;
		ur3 = RTLN(eif_new_type(188, 0x00).id);
...
/* {ETF_NEW_PRESCRIPTION_INTERFACE}.new_prescription_precond */
EIF_TYPED_VALUE F1131_10383 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
	char *l_feature_name = "new_prescription_precond";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1130, Current, 0, 3, 16326);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16326);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb2) {
		tr1 = RTMS_EX_H("ID_PT = INTEGER_64",18,1086248244);
		ur1 = tr1;
