/*
 * Code for class ETF_DPR_Q_INTERFACE
 */
...
extern void F1133_10386(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1133(void);
extern EIF_REFERENCE _A1133_57();
...
/* {ETF_DPR_Q_INTERFACE}.make */
void F1133_10386 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1132, Current, 0, 3, 16328);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 16328);
	RTCC(arg1, 1132, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1132, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1132, l_feature_name, 3, eif_new_type(939, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1133_57, (EIF_POINTER)(0),8005, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
	*(EIF_REFERENCE *)(Current + RTWA(7978, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(3);
