...
extern EIF_TYPED_VALUE F1144_10601(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1144_10603(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1144_10601 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1143, Current, 2, 3, 16624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1143, Current, 16624);
	RTCC(arg1, 1143, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1144_10603 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1143, Current, 0, 1, 16623);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1143, Current, 16623);
	RTIV(Current, RTAL);
	RTHOOK(1);
