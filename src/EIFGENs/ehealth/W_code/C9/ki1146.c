...
extern EIF_TYPED_VALUE F1146_10608(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1146_10609(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1146_10608 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1145, Current, 0, 0, 16625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1145, Current, 16625);
	RTIV(Current, RTAL);
...
body:;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8209, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1146_10609 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1145, Current, 0, 1, 16626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1145, Current, 16626);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	...
	RTNHOOK(1,1);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6339, "maximum_byte_code", tr1))(tr1)).it_i4);
