...
feature {NONE} -- auxiliary procedures
  ...
  add_physician(
      id: ID_MD = INTEGER_64 ; 
      name: NAME = STRING ; 
      kind: PHYSICIAN_TYPE = {generalist, specialist}
  )
  add_patient(
      id: ID_PT = INTEGER_64 ; 
      name: NAME = STRING
  ...
  add_medication(
      id: ID_MN = INTEGER_64 ; 
      medicine: MEDICATION = TUPLE[name: NAME = STRING; kind: KIND = {pill, liquid}; low: VALUE; hi: VALUE]
  )
  add_interaction(
      id1: ID_MN = INTEGER_64 ; 
      id2: ID_MN = INTEGER_64
  )
  new_prescription(
      id: ID_RX = INTEGER_64 ; 
      doctor: ID_MD = INTEGER_64 ; 
      patient: ID_PT = INTEGER_64
  )
  add_medicine(
      id: ID_RX = INTEGER_64 ; 
      medicine: ID_MN = INTEGER_64 ; 
      dose: VALUE
  )
  remove_medicine(
      id: ID_RX = INTEGER_64 ; 
  ...
  prescriptions_q(
      medication_id: ID_MN = INTEGER_64
  )
  dpr_q
]"
 feature -- ETF Version 
